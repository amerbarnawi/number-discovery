export const gameData = {
  ...
  guide: {
    ...
    description: [
      ...
      "Do not repeat numbers that you have previously tried, because the result will be the same.",
      "Do not write a duplicate number in one experiment unless you suspect that the computer number is a duplicate, for example: 1111",
      "Always analyze your results and add useful results to the 'Important list'",
      "Always pay attention to the time, it is important in evaluating your final result.",
    ],
  },
  rules: {
    ...
    description: [
      ...
      "If you get three (+) signs in one trial, you get a brain & star.",
      "You will not get anything if you repeat a number, on the contrary, you will lose.",
  ...
  evaluation: {
    ...
    description: [
      ...
      "Every brain you earn will increase your balance by six marks ( + Brain = +6).",
